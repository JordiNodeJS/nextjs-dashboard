                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700 text-gray-900 dark:text-gray-100">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group">
                      ...
                      <td className="whitespace-nowrap bg-white dark:bg-gray-900 px-4 py-5 text-sm dark:text-gray-100">
                        {customer.email}
                      </td>
                      <td className="whitespace-nowrap bg-white dark:bg-gray-900 px-4 py-5 text-sm dark:text-gray-100">
                      ...
                      <td className="whitespace-nowrap bg-white dark:bg-gray-900 px-4 py-5 text-sm dark:text-gray-100 group-first-of-type:rounded-md group-last-of-type:rounded-md">
                        {customer.total_paid}
                      </td>
                    </tr>
                  ))}
